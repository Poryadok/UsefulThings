...
namespace PM.UsefulThings.UIBinding.Components
{
    ...
    public class GraphicFixedColorIntBinding : BaseBinding<IntProperty>
    {
        ...
        [SerializeField] private CheckType m_checkType = CheckType.Equal;
        [SerializeField] private string m_value = "0";
        [SerializeField] private bool m_invert = false;
        [SerializeField] private Color m_colorTrue = Color.white;
        [SerializeField] private Color m_colorFalse = Color.white;
        ...
        private void ParseValues()
        {
            ...
            switch (m_checkType)
            {
                ...
                case CheckType.InRange:
                {
                    ...
                    {
#if UNITY_EDITOR
                        Debug.LogErrorFormat("Couldn't parse \"{0}\" to \"{1}\" check type", m_value,
                            m_checkType.ToString());
#endif
                        return;
                    }
        ...
        protected override void OnUpdateValue()
        {
            ...
            switch (m_checkType)
            {
                case CheckType.Equal:
                {
                    ...
                    {
                        if (m_invert ? propertyValue != value : propertyValue == value)
                        {
                            result = true;
                            break;
                        }
